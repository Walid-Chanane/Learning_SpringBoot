...
public class CruddemoApplication {
	...
	public CommandLineRunner commandLineRunner(AppDAO appDAO){
		return runner -> {
			...
			//deleteCourse(appDAO);   //nothung new here
	...
	private void addMoreCoursesToStudent(AppDAO appDAO) {
		...
		Course tempCourse2 = new Course("fatafeet");

		//adding the courses to the student
	...
	private void findStudentAndCourses(AppDAO appDAO) {
		...
		//print student and associated courses
	...
	private void findCourseAndStudents(AppDAO appDAO) {
		...
		//print course and associated students
	...
	private void createCourseAndStudent(AppDAO appDAO) {
		...
		//create the course(s)
		Course tempCourse = new Course("art of war");

		//create the student(s)
		Student tempStudent1 = new Student("Cao", "Cao", "caocao@gmail.rok");
		Student tempStudent2 = new Student("lu", "piao", "lupiao@gmail.com");

		//associate the 2 objects(add students to the course)
		tempCourse.addStudent(tempStudent1);
		tempCourse.addStudent(tempStudent2);

		//save the course(and the associated students automatically)
